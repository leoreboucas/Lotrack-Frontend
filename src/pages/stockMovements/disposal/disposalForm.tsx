...
import { disposalSchema, type DisposalFormData } from "./schema";
...
export const DisposalForm = () => {
  ...
  const onSubmit = (data: DisposalFormData) => {
    create(
      { resource: "movements/disposals", values: data },
      { onSuccess: () => navigate("/") },
    );
  };
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold">Novo descarte</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Registre a baixa de um lote por descarte.
        </p>
      </div>
          ...
          >
            ...
            <div className="flex justify-end gap-3 pt-2 sm:col-span-2">
              ...
              <Button type="submit" disabled={mutation.isPending}>
                {mutation.isPending ? "Salvando..." : "Registrar descarte"}
              </Button>
            </div>
          </form>
        </CardContent>
